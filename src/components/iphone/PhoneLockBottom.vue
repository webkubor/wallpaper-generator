<template>
    <svg width="300" height="52" viewBox="0 0 300 52" fill="none" xmlns="http://www.w3.org/2000/svg" class="filter-none">
        ...
        <g filter="url(#filter1_b_424_1527)">
            <g clip-path="url(#clip1_424_1527)">
                <rect width="50" height="50" rx="25" transform="matrix(1 0 0 -1 260 50)" fill="black"
                    fill-opacity="0.45"></rect>
            </g>
            <path
                d="M285 20.8332C285 19.5311 283.881 18.4165 282.5 18.4165H280.417L279.583 17.0832C279.333 16.5207 278.75 16.1665 278.083 16.1665H271.917C271.25 16.1665 270.667 16.5207 270.417 17.0832L269.583 18.4165H267.5C266.119 18.4165 265 19.5311 265 20.8332V31.6665C265 32.9686 266.119 34.0832 267.5 34.0832H282.5C283.881 34.0832 285 32.9686 285 31.6665V20.8332ZM275 29.9998C272.239 29.9998 270 27.7613 270 24.9998C270 22.2384 272.239 19.9998 275 19.9998C277.761 19.9998 280 22.2384 280 24.9998C280 27.7613 277.761 29.9998 275 29.9998Z"
                fill="#FFFFFF"></path>
        </g>
        <g filter="url(#filter1_b_424_1527)">
            <g clip-path="url(#clip1_424_1527)">
